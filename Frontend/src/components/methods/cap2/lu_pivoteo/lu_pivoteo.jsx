      ...
      <header className="sticky top-0 z-10 bg-[var(--paper)]/90 backdrop-blur border-b border-[var(--line)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-[17px] font-editorial">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="rounded-xxl border border-[var(--line)] bg-[var(--card)] p-5 shadow-soft">
              <h3 className="text-lg font-semibold flex items-center gap-2">
                <HelpCircle className="h-5 w-5 text-[var(--copper)]" /> LU con
                pivoteo parcial
              </h3>
              <p className="mt-3 text-[var(--ink-soft)]">
                Factorización con permutación de filas:{" "}
                <strong>P·A = L·U</strong>. El pivoteo evita ceros/valores muy
                pequeños en la diagonal de U y mejora estabilidad numérica.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            {methodForm({
              ...
              error,
              submitText: "Calcular",
              methodName: "LU con pivoteo parcial",
            })}
          </div>
