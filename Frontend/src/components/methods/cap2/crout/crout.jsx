...
const CroutPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ⏱️ medir tiempo total de la llamada
      ...
      // 🔗 guardar resultado para el informe del capítulo 4
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="rounded-xxl border border-[var(--line)] bg-[var(--card)] p-5 shadow-soft">
              ...
              <p className="mt-3 text-[var(--ink-soft)]">
                Factorización <strong>A = L·U</strong> donde <strong>L</strong>{" "}
                tiene diagonal <em>no unitaria</em> y <strong>U</strong> tiene
                diagonal <em>unitaria</em> (unos). Recomendado cuando la matriz
                es no singular y estable numéricamente; si hay pivotes
