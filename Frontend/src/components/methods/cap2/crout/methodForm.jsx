      ...
      <div className="px-6 pb-6">
        <div className="mb-5 p-4 rounded-xl border border-[var(--line)] bg-[color-mix(in_olab,var(--paper)_88%,var(--copper)_12%)]/25">
          <p className="text-sm text-[var(--ink-soft)]">
            Crout produce <strong>L</strong> con diagonal libre y <strong>U</strong> con diagonal de <strong>unos</strong>.
            Si aparecen pivotes conflictivos, considere LU con pivoteo.
          </p>
        </div>
