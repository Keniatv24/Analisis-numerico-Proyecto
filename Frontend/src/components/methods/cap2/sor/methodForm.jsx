      ...
      <div className="px-6 pb-6">
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Valor w</label>
              <input type="text" value={w} onChange={onWChange} className="w-full px-3 py-2 border border-[var(--line)] rounded-lg text-[var(--ink)] focus:ring-2 focus:ring-[var(--copper)]" />
            </div>
            <div>
