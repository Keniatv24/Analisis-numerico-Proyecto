...
const sor = () => {
  ...
  const handleWChange = (e) => setFormData({ ...formData, w: e.target.value });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post("calculations/cap2/sor/", requestData);
    ...
    <div className="min-h-screen bg-[var(--paper)] text-[var(--ink)] font-ui">
      ...
      <header className="sticky top-0 z-10 bg-[var(--paper)]/90 backdrop-blur border-b border-[var(--line)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <span className="text-[17px] font-editorial">Sor</span>
              <button
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="rounded-xxl border border-[var(--line)] bg-[var(--card)] p-5 shadow-soft">
              <h3 className="text-lg font-semibold flex items-center gap-2">
                <HelpCircle className="h-5 w-5 text-[var(--copper)]" /> Método de Sor
              </h3>
      ...
      <main className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            {results ? (
              <MethodResults results={results} methodName="Sor" />
            ) : (
