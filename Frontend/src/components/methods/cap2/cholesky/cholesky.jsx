          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="rounded-xxl border border-[var(--line)] bg-[var(--card)] p-5 shadow-soft">
              ...
              <p className="mt-3 text-[var(--ink-soft)]">
                Factoriza matrices <strong>simétricas definidas positivas</strong>:{" "}
                <strong>A = L · Lᵀ</strong>. Si A no es SPD, el método falla (usa
                LU/Doolittle o pivoteo).
              </p>
            </div>
          </div>
        </div>
