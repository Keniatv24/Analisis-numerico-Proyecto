      ...
      <div className="px-6 pb-6">
        <div className="mb-5 p-4 rounded-xl border border-[var(--line)] bg-[color-mix(in_olab,var(--paper)_88%,var(--copper)_12%)]/25">
          <p className="text-sm text-[var(--ink-soft)]">
            Este LU es <strong>sin pivoteo</strong> (Doolittle). Asegúrese de que
            <strong> U[i,i] ≠ 0</strong>. Si no se cumple, use “LU con pivoteo”.
          </p>
        </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                disabled={n <= 2}
                className="w-8 h-8 bg-[var(--card)] border border-[var(--line)] rounded-lg flex items-center justify-center disabled:opacity-50"
              >
                -
              </button>
