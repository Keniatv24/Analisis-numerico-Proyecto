    ...
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-3.5">
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            <label htmlFor="first-derivate" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white pl-10"
                placeholder=" 3 * x ^ 2 - 2"
                required
              />
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <div className="space-y-2">
            <label htmlFor="second-derivate" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
