...
/**
 * Capítulo 3 — Interpolación (PulsoMatematico)
 * - Misma estética editorial
 * - Tarjetas hacia: /metodos/vander, /metodos/newton-interpolante, /metodos/lagrange, /metodos/spline
 */
